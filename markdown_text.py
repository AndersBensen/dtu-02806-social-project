...
The dataset contains information about injuries and deaths caused by collisions involving cars, cycles and pedestrians in New York City. The timespan 
ranges between the years 2012-2021 with 1,765,789 counts and 29 variables. This website sets out to investigate the different temporal and geospatial patterns 
hidden behind the rather large amount of data, and more specifically it sets out to investigate how COVID-19 has affected the data. 
...
To get an initial overview of the data a so-called choropleth map is used. The map shows simply how many collisions there where in each of the 5
...
The plots show key differences in how the different modes of transport play into danger levels of collisions in the five boroughs. In the Manhattan borough, you are much less likely to be injured in a collision as a motorist compared to the other boroughs. This is likely due to a high amount of collisions 
...
higher amount of collisions involving only motorists.
...
We could also see from the COVID-19 investigation, that COVID19 definetely had an impact on the amount collisions and related fatalities in NYC. 
...
in the specific boroughs. The same specific part of the data from the last model was chosen to test the new model, the resulting figure can be seen below: 
'''
